...
const FormEdit = function () {
    ...
    const [edit, setEdit] = useState(true) //should be handle by document finalization
    ...
    return (
        <Card
            ...
            bordered={false}
        >
            <Form layout="vertical" form={form} initialValues={...defaultData as any} disabled={edit} onChange={onSave}>
