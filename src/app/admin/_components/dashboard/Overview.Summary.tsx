...
const DummyData: ChartData = {
    ...
    datasets: [
        ...
        {
            label: 'Failed',
            data: randomData.map(item => Math.random() * 50),
            fill: true,
            borderColor: 'gray',
        ...
        {
            label: 'Retrieved',
            data: randomData.map(item => Math.random() * 75),
            fill: true,
...
const SummaryItems = function () {
    return (
        <>
            <Line data={DummyData as any} options={{ responsive: true, maintainAspectRatio: false }} style={{ maxHeight: '50vh', minHeight: '50vh' }} />
        </>
    )
}
