...
import { saveNewUser } from "@state/users/actions";
...
function FormDrawer(props: FormDrawerProps) {
    ...
    const onSubmit = async () => {
        ...
        const result = await saveNewUser(formData);
    ...
    return (
        <>
            <Form form={form} initialValues={{ userType: "USER" }} layout={"vertical"} onFinish={onSubmit}>
                <Flex align="center" justify="center">
                    <Form.Item>
                        <AvatarUploader onSave={onImageUpload} />
                    </Form.Item>
                </Flex>
                <Flex align="center" justify="center">
