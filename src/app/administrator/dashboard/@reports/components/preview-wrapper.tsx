...
//components
import { DocumentPreviewThemeConfig } from "./preview-config";
//styles
import { PreviewPaneStyle, PrintablePaneStyle, ScrollStyle, WrapperStyles } from "./styles";
//compoents
const ReportsPreviewWrapper = forwardRef(function PreviewWrapper(
...
export default memo(ReportsPreviewWrapper);
