            ...
            <Result
                ...
                extra={
                    <div style={{ textAlign: 'center' }}>
                        <p>If Error Persist, Please File a Bug Report on our <a href="/">Bug Tracker <Tag color="orange">TODO</Tag></a></p>
                        <Button icon={<ReloadOutlined />} onClick={() => reset()}>Reload and Retry</Button>
                    </div>
                }
            />
        </div>
